...
export function NotificationsDrawer({
  ...
  return (
    <aside className="absolute inset-0 z-[80] bg-sage/35">
      <div className="absolute inset-y-0 right-0 w-[82%] max-w-[320px] rounded-l-[34px] bg-rose px-7 pt-10 shadow-[-18px_0_45px_rgba(108,118,93,0.28)]">
        <button
          type="button"
          onClick={onClose}
