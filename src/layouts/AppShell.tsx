...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[#ECEEE8] px-3 py-4 font-sans antialiased sm:flex sm:items-center sm:justify-center">
      <div className="relative mx-auto h-[844px] w-full max-w-[390px] overflow-hidden rounded-[38px] bg-white ">
        <div className="h-full overflow-y-auto overflow-x-hidden pb-[88px] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {children}
        </div>
              ...
              ({
                ...
                if (isCenter) {
                  return (
                    <li
                      key={id}
                      className="relative flex h-[36px] justify-center"
                    >
                      <button
                        type="button"
                        onClick={() =>
